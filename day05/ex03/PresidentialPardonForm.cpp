...
PresidentialPardonForm::PresidentialPardonForm() : Form("presidential pardon", 72, 45, "me")
{
}

PresidentialPardonForm::PresidentialPardonForm(std::string const &target) : Form("presidential pardon", 72, 45, target)
{
}
